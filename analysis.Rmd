...
brgdgt_ab_plot <- 
  ...
  scale_y_continuous(NULL, breaks = c(0.005, 0.015, 0.025), expand = expansion(mult = c(0, 0.03)), labels = scales::percent) +
...
fames_ab_plot <- 
  ...
  scale_y_continuous(NULL, breaks = c(0.1, 0.3, 0.5, 0.7), expand = expansion(mult = c(0, 0.03)), labels = scales::percent) +
  scale_fill_manual(NULL, values = c("#FCDE05", "#FF5473", "#A696FF"))
...
plot_grid(
  ...
  brgdgt_ab_plot_middle, fames_ab_plot_bottom, 
...
lipids_table %>% export_to_excel(file = "tables/table_S1.xlsx", dbl_format = "PERCENTAGE")
